...
urlpatterns = [
    ...
    path("signup/", users_views.user_register, name="regester"),
    path("signin/", users_views.user_register, name="signin"),
    path("signout/", users_views.user_register, name="signout"),
